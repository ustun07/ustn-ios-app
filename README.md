# Üstün Restorant - Modern Restaurant Order App | iOS QR Code Ordering System
...
<meta name="description" content="Üstün Restorant: iOS için modern restoran sipariş uygulaması. QR kod ile masa seçimi, menü yönetimi, favoriler, sipariş takibi. SwiftUI ve MVVM mimarisi ile geliştirilmiş premium restoran uygulaması.">
<meta name="keywords" content="restoran uygulaması, QR kod sipariş, iOS uygulama, SwiftUI, restoran sipariş sistemi, mobil sipariş, üstün restorant">
...
<div align="center">
  ...
  <p><strong>Masalardan doğrudan sipariş verme deneyimi</strong></p>
...
## 📱 Ustn Restorant Nedir? | Restoran Sipariş Uygulaması Hakkında

**Ustn Restorant**, restoran ve yemek işletmeleri için geliştirilmiş modern bir **mobil sipariş uygulaması**dır. Müşterilerin masalarından doğrudan sipariş verebilecekleri bu iOS uygulaması, **QR kod tarama**, **menü yönetimi**, **sipariş takibi** ve **favoriler sistemi** gibi gelişmiş özellikler sunar.

Ustn Restorant, Apple'ın minimalizm felsefesi ile Türk mutfağının sıcak atmosferini birleştiren **"premium ama samimi"** bir kullanıcı deneyimi sunar. Uygulama, SwiftUI ve MVVM mimarisi kullanılarak geliştirilmiştir ve iOS 17+ cihazlarda çalışır.

## ✨ Ustn Restorant Uygulaması Özellikleri

### 📋 Menü ve Sipariş Özellikleri
- **Modern Menü Görüntüleme**: Glassmorphism, parallax scroll ve 3D efektlerle zengin menü deneyimi
- **Kategorilere Ayrılmış Menü**: Yiyecekler, İçecekler, Tatlılar, Ekstralar
...
- **Porsiyon Seçimi**: Normal, 1.5 Porsiyon ve Duble seçenekleri
...
## 🛠 Ustn Restorant Teknoloji Stack'i | Kullanılan Teknolojiler

Ustn Restorant uygulaması, modern iOS geliştirme standartlarına uygun olarak geliştirilmiştir:
...
## 🚀 Ustn Restorant Uygulamasını Kurma | Installation Guide
...
## 📖 Ustn Restorant Kullanım Kılavuzu | Kullanıcı Rehberi
...
- Menü kategorilere ayrılmıştır:
  - 🍖 Yiyecekler (İskender, Köfte, Döner, vb.)
  - � İçecekler (Ayran, Şalgam, Çay, vb.)
  - 🍮 Tatlılar (Sütlaç, Baklava, Kunefe, vb.)
  - 🥗 Ekstralar (Salata, Meze, vb.)
...
- Sipariş durumları:
  ...
  - 👨‍🍳 **Hazırlanıyor**: Aşçı siparişinizi hazırlıyor
  - ✅ **Hazır**: Siparişiniz hazır, garson size ulaştıracak
...
## 🏗 Ustn Restorant Proje Yapısı | Kod Organizasyonu

Ustn Restorant, **MVVM (Model-View-ViewModel)** mimarisi ile organize edilmiştir:
...
│   ├── UstnLogo.imageset/          # Ustn logosu
│   ├── TableQRCodes.imageset/      # Masa QR kodları
...
### 📦 Bağımlılıklar
Ustn Restorant, **Firebase** ve native iOS framework'leri kullanır:
- SwiftUI (UI)
- AVFoundation (Kamera)
- Combine (Reactive Programming)
- Firebase Auth (Kullanıcı Doğrulama)
- Firebase Firestore (Bulut Veritabanı)
- Firebase Analytics (Uygulama Analitiği)

---

## 🎨 Ustn Restorant Tasarım Sistemi | UI/UX Design

Ustn Restorant, **sıcak kahverengi tonlarda minimalist** bir tasarım dilini benimser. Tasarım, Apple'ın Human Interface Guidelines ile uyumludur.
...
- **Coffee Steam Animation**: Logo üzerinde yükselen buhar efekti
- **Particle Effects**: Arka planda yüzen parçacık efektleriding glow rings ve radial glow efektleri
...
Ustn Restorant uygulaması, **çoklu dil desteği** ile geliştirilmiştir:
...
**Selim Can Üstün**
- 💼 iOS Geliştirici
- 📧 Email: selimcan@ustn.com
- 🔗 GitHub: [@selimcanustun](https://github.com/selimcanustun)
...
<div align="center">
  <strong>Ustn Restorant ile lezzet keyfinizi yaşayın! 🍖✨</strong>
</div>
